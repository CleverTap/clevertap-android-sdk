...
object AndroidVersion {
    ...
    const val clevertapAndroidSdk = "5.0.0"
    const val clevertapRendermaxSdk = "1.0.3"
    const val clevertapGeofenceSdk = "1.2.0"
    const val clevertapHmsSdk = "1.3.2"
    const val clevertapXiaomiSdk = "1.5.2"
    const val clevertapPushTemplates = "1.0.9"
    const val clevertapBoM = "1.0.0"
