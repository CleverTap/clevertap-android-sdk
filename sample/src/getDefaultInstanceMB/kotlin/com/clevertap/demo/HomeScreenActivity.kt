...
import com.clevertap.demo.TAG
import com.clevertap.demo.R.id
import com.clevertap.demo.R.layout
import com.clevertap.demo.ui.main.HomeScreenFragment
import com.clevertap.demo.ui.main.HomeScreenFragment.Companion
...
class HomeScreenActivity : AppCompatActivity()/*, CTInboxListener, DisplayUnitListener, CTProductConfigListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(layout.home_screen_activity)

        Logger.v("onCreate() called for HomeScreenActivity - getDefaultInstanceMB")
        Log.i(TAG, "is Instant app? - ${InstantApps.isInstantApp(this)}")
        if (savedInstanceState == null) {
            supportFragmentManager.commitNow {
                replace(id.container, HomeScreenFragment.newInstance())
            }
        }
...
//            Logger.v("nano time ct init = $measureNanoTime")
        ...
        Logger.v("nano time ct init = ${nanoTimeEnd-nanoTimeStart}")*/
...
//        var cleverTapInstanceTwo = CleverTapAPI.instanceWithConfig(this, config)
   ...
   /* override fun onNewIntent(intent: Intent?) {
    ...
    override fun onResume() {
        super.onResume()
        Logger.v("onResume() called for HomeScreenActivity")
    }
}