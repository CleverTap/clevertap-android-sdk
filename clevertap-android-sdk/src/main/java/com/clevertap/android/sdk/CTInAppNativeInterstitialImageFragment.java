...
public class CTInAppNativeInterstitialImageFragment extends CTInAppBaseFullFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View inAppView = inflater.inflate(R.layout.inapp_interstitial_image, container, false);

        FrameLayout fl  = inAppView.findViewById(R.id.inapp_interstitial_image_frame_layout);
        fl.setBackgroundDrawable(new ColorDrawable(0xBB000000));
        RelativeLayout relativeLayout = fl.findViewById(R.id.interstitial_image_relative_layout);
