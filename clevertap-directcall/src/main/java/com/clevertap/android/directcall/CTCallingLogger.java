...
public final class CTCallingLogger {
    ...
    public CTCallingLogger(@LogLevel int level) {
        setDebugLevel(level);
    }
    ...
    public void debug(String suffix, String message) {
        if (debugLevel > INFO) {
            if (message.length() > 4000) {
                Log.d(Constants.LOG_TAG + ":" + suffix, message.substring(0, 4000));
                debug(suffix, message.substring(4000));
            } else {
                Log.d(Constants.LOG_TAG + ":" + suffix, message);
            }
        }
    }
    ...
    public void debug(String suffix, String message, Throwable t) {
        if (debugLevel > INFO) {
            Log.d(Constants.LOG_TAG + ":" + suffix, message, t);
        }
    }
    ...
    public void info(String suffix, String message) {
        if (debugLevel >= INFO) {
            Log.i(Constants.LOG_TAG + ":" + suffix, message);
        }
    }

    public void info(String suffix, String message, Throwable t) {
        if (debugLevel >= INFO) {
            Log.i(Constants.LOG_TAG + ":" + suffix, message, t);
        }
    }
    ...
    public void verbose(String suffix, String message) {
        if (debugLevel > DEBUG) {
            if (message.length() > 4000) {
                Log.v(Constants.LOG_TAG + ":" + suffix, message.substring(0, 4000));
                verbose(suffix, message.substring(4000));
            } else {
                Log.v(Constants.LOG_TAG + ":" + suffix, message);
            }
        }
    }
    ...
    public void verbose(String suffix, String message, Throwable t) {
        if (debugLevel > DEBUG) {
            Log.v(Constants.LOG_TAG + ":" + suffix, message, t);
        }
    }
