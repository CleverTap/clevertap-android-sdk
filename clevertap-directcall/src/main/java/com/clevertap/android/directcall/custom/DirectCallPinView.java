 ...
 */
public class DirectCallPinView extends AppCompatEditText {
    ...
    public DirectCallPinView(Context context) {
        this(context, null);
    }

    public DirectCallPinView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.pinViewStyle);
    }

    public DirectCallPinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.DCPinView, defStyleAttr, 0);

        mViewType = a.getInt(R.styleable.DCPinView_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.DCPinView_itemCount, DEFAULT_COUNT);
        mPinItemHeight = (int) a.getDimension(R.styleable.DCPinView_itemHeight,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(R.styleable.DCPinView_itemWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.DCPinView_itemSpacing,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.DCPinView_itemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.DCPinView_lineWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.DCPinView_lineColor);
        isCursorVisible = a.getBoolean(R.styleable.DCPinView_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.DCPinView_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.DCPinView_cursorWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_cursor_width));

        mItemBackground = a.getDrawable(R.styleable.DCPinView_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(R.styleable.DCPinView_hideLineWhenFilled, false);
