...
implementation "com.clevertap.android:clevertap-android-sdk:5.0.0" // 4.4.0 and above
```
...
* For images in Basic, Auto/Manual Carousel, Zero Bezel  the image dimensions should not exceed more than 400x200 for only Android 13+ devices.
