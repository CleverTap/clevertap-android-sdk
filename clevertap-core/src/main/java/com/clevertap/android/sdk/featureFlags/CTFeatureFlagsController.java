...
public class CTFeatureFlagsController {
        ...
        task.execute("fetchFeatureFlags", new Callable<Void>() {
            ...
            public Void call() {
                try {
                    ...
                    Logger.verbose(getLogTag(), e.getLocalizedMessage());
                }
                return null;
            }
        });
    ...
    public synchronized void updateFeatureFlags(JSONObject jsonObject) throws JSONException {
        ...
        try {
            ...
            Logger.verbose(getLogTag(), "Updating feature flags..." + store);
        } catch (JSONException e) {
            Logger.verbose(getLogTag(), "Error parsing Feature Flag array " + e.getLocalizedMessage());
        }
    ...
    void init() {
        ...
        task.execute("initFeatureFlags", new Callable<Boolean>() {
            ...
            public Boolean call() {
                synchronized (this) {
                    Logger.verbose(getLogTag(), "Feature flags init is called");
                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(content)) {
                            ...
                            Logger.verbose(getLogTag(), "Feature flags initialized from file " + fileName +
                                    " with configs  " + store);
                        } else {
                            Logger.verbose(getLogTag(), "Feature flags file is empty-" + fileName);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                        Logger.verbose(getLogTag(),
    ...
    private synchronized void archiveData(JSONObject featureFlagRespObj) {
        ...
        if (featureFlagRespObj != null) {
            try {
                ...
                e.printStackTrace();
                Logger.verbose(getLogTag(), "ArchiveData failed - " + e.getLocalizedMessage());
            }
        }
    }
