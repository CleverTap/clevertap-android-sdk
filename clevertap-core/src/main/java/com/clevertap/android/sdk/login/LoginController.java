        ...
        task.execute("resetProfile", new Callable<Void>() {
            ...
            public Void call() {
                try {
                    ...
                    baseEventQueueManager.flushQueueSync(context, EventGroup.REGULAR, null);
                    baseEventQueueManager.flushQueueSync(context, EventGroup.PUSH_NOTIFICATION_VIEWED, null);
