...
public interface Constants {
    ...
    //Push Templates Constants
    String LOG_TAG = "PTLog";
    String PT_MANUAL_CAROUSEL_CURRENT = "pt_manual_carousel_current";
    String PT_IMAGE_LIST = "pt_image_list";
    String PT_COLLAPSE_KEY = "pt_ck";
    String PT_DEEPLINK_LIST = "pt_deeplink_list";
    String PT_FLIP_INTERVAL = "pt_flip_interval";
    String PT_DIR = "pt_dir";
    String PT_SOUND_FILE_NAME = "pt_silent_sound";
    String PT_RATING_C2A_KEY = "rating_";
    String PT_5CTA_C2A_KEY = "5cta_";
    String PT_VIDEO_C2A_KEY = "video_";
    String PT_CUSTOM_CTA_BG_CLR = "pt_custom_cta_bg_clr";
    String PT_CUSTOM_CTA_TEXT_CLR = "pt_custom_cta_text_clr";
    String PT_CUSTOM_CTA_TEXT = "pt_custom_cta_text";
    String PT_CUSTOM_CTA_DL = "pt_custom_cta_dl";
    String PT_PRICE_LIST = "pt_price_list";
    String PT_SMALLTEXT_LIST = "pt_small_text_list";
    String PT_BIGTEXT_LIST = "pt_big_text_list";
    String PT_MANUAL_CAROUSEL_TYPE = "pt_manual_carousel_type";
    String PT_MANUAL_CAROUSEL_FILMSTRIP = "filmstrip";
    boolean PT_FALLBACK = false;
    String PT_IMAGE_PATH_LIST = "";
    int ONE_SECOND = 1000;
    String DEFAULT_DL = "default_dl";
//     String WZRK_ACTIONS = "wzrk_acts";
//     String WZRK_CHANNEL_ID = "wzrk_cid";
//     String WZRK_PUSH_ID = "wzrk_pid";
//     String WZRK_DL = "wzrk_dl";
//     String WZRK_FROM_KEY = "wzrk_from";
//     String WZRK_FROM = "CTPushNotificationReceiver";
//     int EMPTY_NOTIFICATION_ID = -1000;
     String NOTIF_TAG = "wzrk_pn";
//     String ICON_BASE_URL = "http://static.wizrocket.com/android/ico/";
//     String LABEL_NOTIFICATION_ICON = "CLEVERTAP_NOTIFICATION_ICON";
     String PT_ID = "pt_id";
     String PT_NOTIF_ICON = "pt_ico";
     String PT_TITLE = "pt_title";
     String PT_MSG = "pt_msg";
     String PT_MSG_SUMMARY = "pt_msg_summary";
     String PT_TITLE_COLOR = "pt_title_clr";
     String PT_MSG_COLOR = "pt_msg_clr";
     String PT_BG = "pt_bg";
     String PT_BIG_IMG = "pt_big_img";
     String PT_SMALL_IMG = "pt_small_img";
     String PT_JSON = "pt_json";
     String PT_BUY_NOW_DL = "pt_buy_now_dl";
     String PT_DEFAULT_DL = "pt_default_dl";
     String PT_SMALL_VIEW = "pt_small_view";
     String PT_TIMER_THRESHOLD = "pt_timer_threshold";
     String PT_INPUT_LABEL = "pt_input_label";
     String PT_INPUT_KEY = "pt_input_reply";
     String PT_INPUT_FEEDBACK = "pt_input_feedback";
     int PT_INPUT_TIMEOUT = 1300;
     String PT_NOTIF_ID = "notificationId";
     String PT_INPUT_AUTO_OPEN = "pt_input_auto_open";
     String PT_EVENT_NAME_KEY = "pt_event_name";
     String PT_EVENT_PROPERTY_KEY = "pt_event_property";
     String PT_EVENT_PROPERTY_SEPERATOR = "pt_event_property_";
     String PT_DISMISS_ON_CLICK = "pt_dismiss_on_click";
     String PT_CHRONO_TITLE_COLOUR = "pt_chrono_title_clr";
     String PT_VIDEO_URL = "pt_video_url";
     String PT_PRODUCT_DISPLAY_ACTION = "pt_product_display_action";
     String PT_PRODUCT_DISPLAY_ACTION_COLOUR = "pt_product_display_action_clr";
     String PT_TIMER_END = "pt_timer_end";
     String PT_TIMER_SPLIT = "$D_";
     int PT_TIMER_MIN_THRESHOLD = 10;
     String PT_BIG_IMG_ALT = "pt_big_img_alt";
     String PT_TITLE_ALT = "pt_title_alt";
     String PT_MSG_ALT = "pt_msg_alt";
     String PT_PRODUCT_DISPLAY_LINEAR = "pt_product_display_linear";
     String WZRK_CLR = "wzrk_clr";
     String PT_PRODUCT_DISPLAY_ACTION_TEXT_COLOUR = "pt_product_display_action_text_clr";
     String PT_SMALL_ICON_COLOUR = "pt_small_icon_clr";
//     String WZRK_BIG_PICTURE = "wzrk_bp";
//     String WZRK_MSG_SUMMARY = "wzrk_nms";
//     String NOTIF_PRIORITY = "pr";
//     String PRIORITY_HIGH = "high";
...
//     String WZRK_SOUND = "wzrk_sound";
//     String WZRK_TIME_TO_LIVE = "wzrk_ttl";
     String WZRK_C2A = "wzrk_c2a";
     String PT_META_CLR = "pt_meta_clr";
//     String NOTIF_MSG = "nm";
//     String NOTIF_TITLE = "nt";
     String PT_CANCEL_NOTIF_ID = "pt_cancel_notif_id";
     String PT_ACTION_ID = "actionId";
     String PT_RIGHT_SWIPE = "right_swipe";
     String PT_MANUAL_CAROUSEL_FROM = "manual_carousel_from";
     String PT_IMAGE_1 = "img1";
     String PT_CURRENT_POSITION = "pt_current_position";
     String PT_TOTAL_COUNT = "pt_total_count";
     String PT_IMAGE_AVAILABILITY_ARRAY = "pt_image_availability_array";
     String PT_BUY_NOW = "buynow";
     String TEXT_ONLY = "text_only";
     String PT_TYPE = "pt_type";
     String PT_SUBTITLE = "pt_subtitle";
     String PT_DISMISS_INTENT = "pt_dismiss_intent";
     String PT_SILENT_CHANNEL_ID = "pt_silent_sound_channel";
     CharSequence PT_SILENT_CHANNEL_NAME = "Silent Channel";
     String PT_SILENT_CHANNEL_DESC = "A channel to silently update notifications";
     String PT_RATING_TOAST = "pt_rating_toast";
     String PT_DOT_SEP = "pt_dot_sep";
     String PT_COLOUR_WHITE = "#FFFFFF";
     String PT_COLOUR_GREY = "#A6A6A6";
     String PT_COLOUR_BLACK = "#000000";
     String PT_META_CLR_DEFAULTS = PT_COLOUR_GREY;
     String PT_PRODUCT_DISPLAY_ACTION_CLR_DEFAULTS = "#FFBB33";
     String PT_PRODUCT_DISPLAY_ACTION_TEXT_CLR_DEFAULT = PT_COLOUR_WHITE;
     int PT_CONNECTION_TIMEOUT = 10 * ONE_SECOND;
     int PT_FLIP_INTERVAL_TIME = 4 * ONE_SECOND;
}