...
object InAppFixtures {
    ...
    val TYPE_CUSTOM_HTML_HEADER_WITH_KV = """
        {
          "type": "custom-html",
          "w": {
            "dk": false,
    ...
    val TYPE_CUSTOM_CODE = """
    {
        "type": "custom-code",
        "templateId": "66c3159946486941756b22ab",
        ...
        "vars": {
            ...
            "number": 5,
            "boolean": true,
            "file": "https://test.clevertap/test.jpeg"
        },
        "rfp": false,
        "is_native": true,
        "ti": 1745397430,
        "wzrk_id": "1745397430_20250610",
        "wzrk_pivot": "wzrk_default",
        "priority": 10,
        "whenTriggers": [{
            "eventName": "custom-template"
        }],
        "frequencyLimits": [],
        "excludeGlobalFCaps": -1,
        "occurrenceLimits": [],
    ...
    val TYPE_COVER_WITH_FUNCTION_BUTTON_ACTION = """
    {
        "type": "cover",
        "bg": "#ffffff",
        "tablet": false,
        ...
        "buttons": [{
            ...
            "actions": {
                ...
                "ios": "",
                "kv": {},
                "templateId": "6808a77e9fe6130e607f8e4a",
    ...
    val TYPE_INTERSTITIAL_WITH_MEDIA = """
    {
        "type": "interstitial",
        "bg": "#ffffff",
        "tablet": false,
        ...
        "media": {
            "url": "https://clevertap.example/test.jpeg",
            "poster": "",
            "key": "047e83120624491e9512dcbd59763767",
            "content_type": "image/jpeg",
            "filename": "",
            "processing": false
        },
        ...
        "is_native": true,
        "ti": 1743153944,
        "wzrk_id": "1743153944_20250610",
        "wzrk_pivot": "wzrk_default",
        "priority": 10,
        "whenTriggers": [{
            "eventName": "template-native"
        }],
        "frequencyLimits": [],
        "excludeGlobalFCaps": -1,
        "occurrenceLimits": [],
