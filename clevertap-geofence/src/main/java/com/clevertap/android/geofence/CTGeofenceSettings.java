...
public class CTGeofenceSettings {
    ...
    public static final class Builder {
         ...
         * <li>When true, this will allow SDK to register background location updates through any of the above mentioned fetch modes.</li>
         * <li>When false, this will inform SDK to fetch location only in foreground when the app is
         * launched or through {@link CTGeofenceAPI#triggerLocation()} and not to register background location updates through
         ...
         * {@link #FETCH_LAST_LOCATION_PERIODIC}. Default value is {@link #FETCH_LAST_LOCATION_PERIODIC}
         * @return {@link CTGeofenceSettings.Builder}
         */
